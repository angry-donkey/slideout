...
Slideout.prototype._initTouchEvents = function() {
  ...
  this.panel.addEventListener(touch.start, this._resetTouchFn, { passive: false });
  ...
  this.panel.addEventListener('touchcancel', this._onTouchCancelFn, { passive: false });
  ...
  this.panel.addEventListener(touch.end, this._onTouchEndFn, { passive: false });
